...
<div class="pagetitle mb-4">
    <h1 class="fs-3 fw-bold" style="color: #012970;">Mulai Screening Kesehatan</h1>
    <nav>
        <ol class="breadcrumb mt-1">
            ...
            <li class="breadcrumb-item active">Mulai Screening</li>
        </ol>
    </nav>
</div>
        ...
        <div class="col-lg-12">
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-body pt-4">
                    <form action="{{ route('screenings.store') }}" method="POST" novalidate>
                        @csrf
                        
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="screening_code" class="form-label fw-bold text-muted">Kode Screening</label>
                                <input type="text" class="form-control bg-light" id="screening_code" name="screening_code" value="{{ $screeningCode }}" readonly>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control bg-light" id="screening_date" name="screening_date" value="{{ date('Y-m-d') }}" readonly>
                            </div>
                            
                            <div class="col-md-6 mb-3">
                                <label for="tekanan_darah" class="form-label fw-bold text-muted">Tekanan Darah (mmHg)</label>
                                <input type="text" class="form-control @error('tekanan_darah') is-invalid @enderror" id="tekanan_darah" name="tekanan_darah" value="{{ old('tekanan_darah') }}" placeholder="Contoh: 120/80" required>
                                @error('tekanan_darah')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.1" class="form-control @error('tinggi_badan') is-invalid @enderror" id="tinggi_badan" name="tinggi_badan" value="{{ old('tinggi_badan') }}" required>
                                @error('tinggi_badan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.1" class="form-control @error('hemoglobin') is-invalid @enderror" id="hemoglobin" name="hemoglobin" value="{{ old('hemoglobin') }}" required>
                                @error('hemoglobin')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.1" class="form-control @error('suhu_tubuh') is-invalid @enderror" id="suhu_tubuh" name="suhu_tubuh" value="{{ old('suhu_tubuh') }}" required>
                                @error('suhu_tubuh')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('denyut_nadi') is-invalid @enderror" id="denyut_nadi" name="denyut_nadi" value="{{ old('denyut_nadi') }}" required>
                                @error('denyut_nadi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
